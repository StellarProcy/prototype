...
public class DialogFrame extends JDialog{
	...
	protected void validateFields() throws IllegalArgumentException {
		...
		if (textMonetary.equals("")){
			textMonetary.setText("0");
		} 
		
		if (textName.getText().length() > 15){
			throw new IllegalArgumentException("Название не должно превышать 15 символов");
		}
		try {
	...
	private void init(String name, Monetary current) {
		...
		labelException.setBounds(113, 155, 311, 14);
		...
		label.setBounds(58, 130, 183, 14);
		contentPanel.add(label);
		
		JLabel label_1 = new JLabel("*");
		label_1.setForeground(Color.RED);
		label_1.setBounds(39, 130, 46, 14);
